...
new (0, _cleaveEsmMinJsDefault.default)(cardnumber, {
    creditCard: true
});
new (0, _cleaveEsmMinJsDefault.default)(expirationdate, {
    date: true,
    datePattern: [
        "m",
        "y"
...
/*Переворачивание карты*/ // Что-бы перевернуть карту используйте класс flipped для элемента с классом creditcard
cardFront.addEventListener("click", (e)=>{
    creditcard.classList.add("flipped");
});
securitycode.addEventListener("click", (e)=>{
    creditcard.classList.add("flipped");
});
cardBack.addEventListener("click", (e)=>{
    creditcard.classList.remove("flipped");
});
/*отображение данных на картинке карты*/ cardName.addEventListener("input", (e)=>{
    svgName.textContent = cardName.value;
    svgnameback.textContent = cardName.value;
});
cardnumber.addEventListener("input", (e)=>{
    // удаляем пробелы из строки результата
    cardnumber.value = cardnumber.value.replace(/ /g, "");
    mask.forEach((arr)=>{
        let regExp = new RegExp(`${arr.regex}`);
        if (regExp.test(cardnumber.value)) {
            ccicon.innerHTML = arr.icon;
            cclogo.innerHTML = arr.logo;
            swapColor(arr.color);
            return arr.cardType;
        }
    });
...
},{"../node_modules/redom/dist/redom.es.js":"iahd6","../node_modules/cleave.js/dist/cleave-esm.min.js":"5Q5X9","@parcel/transformer-js/src/esmodule-helpers.js":"8qVmu"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"8qVmu"}]},["4gbls","2OpUZ"], "2OpUZ", "parcelRequire7fc0")
